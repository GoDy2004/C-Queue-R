...
-- Removed for Railway: CREATE DATABASE IF NOT EXISTS queue_system
-- Removed for Railway:   CHARACTER SET utf8mb4
-- Removed for Railway:   COLLATE utf8mb4_unicode_ci;

-- Removed for Railway: USE queue_system;
